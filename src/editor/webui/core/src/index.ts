...
//
//   1. RE-EXPORT the whole workspace surface, so e05d's panels and the hydration runtime import the
//      contract from ONE place and can never hand-roll a divergent copy (the barrel discipline
//      e05a established for the generated client schema, now covering the bridge too).
//   2. BOOT the bridge handshake on load — e05c's deliverable, asserted end to end from the native
//      side by the `editor-cef-smoke-shell` ctest.
//
