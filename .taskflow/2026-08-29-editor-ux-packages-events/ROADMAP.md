...
| `e2` files-panel-write (`tasks/e2-files-panel-write.md`) | `e1` | Context-Engine/main | 7/8 ⚿ | top | In review ⚿ OWNER GATE | [#511](https://github.com/IvanMurzak/Context-Engine/pull/511) shadowing fix | 2026-09-02 |
