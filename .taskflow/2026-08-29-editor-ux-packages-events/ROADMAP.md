...
| `a3` ui-state-model (`tasks/a3-ui-state-model.md`) | — | Context-Engine/main | 6/6 | mid | In review | [#505](https://github.com/IvanMurzak/Context-Engine/pull/505) CI rerun | 2026-09-01 |
| `a4` panel-title-dedup (`tasks/a4-panel-title-dedup.md`) | — | Context-Engine/main | 5/5 | mid | Ready | — | 2026-08-29 |
| `b1` osr-html5-drag (`tasks/b1-osr-html5-drag.md`) | `a0` `a1` `a2` | Context-Engine/main | 9/10 | top | In progress | run `01a05e13-3068` | 2026-09-01 |
...
| `d1` window-menu-panels (`tasks/d1-window-menu-panels.md`) | `c2` `c3` | Context-Engine/main | 6/6 | mid | In progress | run `01a05e5f-9bc9` | 2026-09-01 |
| `d2` package-fact-bus (`tasks/d2-package-fact-bus.md`) | `c1` `c2` | Context-Engine/main | 9/9 ⚿ | top | Planned | — | 2026-08-29 |
| `e1` files-panel-read (`tasks/e1-files-panel-read.md`) | `c1` `c3` | Context-Engine/main | 7/6 | mid | In progress | run `01a05e5f-9cc7` | 2026-09-01 |
