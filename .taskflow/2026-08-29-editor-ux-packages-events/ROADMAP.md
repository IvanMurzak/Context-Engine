...
|---|---|---|---|---|---|---|---|
| `a0` osr-contract-audit (`tasks/a0-osr-contract-audit.md`) | — | Context-Engine/main | 7/5 | mid | In progress | run `01a05c81-aed8` | 2026-09-01 |
| `a1` osr-screen-point (`tasks/a1-osr-screen-point.md`) | — | Context-Engine/main | 8/8 | top | Ready | — | 2026-08-29 |
...
| `c1` selection-subjects (`tasks/c1-selection-subjects.md`) | — | Context-Engine/main | 9/8 | top | In progress | run `01a05c81-b1d9` | 2026-09-01 |
| `c2` manifest-v3 (`tasks/c2-manifest-v3.md`) | — | Context-Engine/main | 8/8 | top | Ready | — | 2026-08-29 |
