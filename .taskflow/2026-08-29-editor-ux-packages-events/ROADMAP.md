...
| `e2` files-panel-write (`tasks/e2-files-panel-write.md`) | `e1` | Context-Engine/main | 7/8 ⚿ | top | **In review ⚿ AWAITING OWNER** | [#511](https://github.com/IvanMurzak/Context-Engine/pull/511) `36b7edf` 42/42 | 2026-09-02 |
...
| `f1` uibus-boundary-denylist (`tasks/f1-uibus-boundary-denylist.md`) | `d2` | Context-Engine/main | 8/7 ⚿ | top | In progress | run `01a05f9a-0d7e` | 2026-09-02 |
