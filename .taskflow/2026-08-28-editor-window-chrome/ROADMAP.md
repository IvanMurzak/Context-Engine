...
|---|---|---|---|---|---|---|---|
| [a1-chrome-contract](tasks/a1-chrome-contract.md) — `chrome.state`, window-control surface, backend virtuals, caption vocabulary, ten smokes | — | . / main | 8/8 | top | 🔵 in-progress | pipeline implement-task | 2026-08-28 |
