...
| [d3-menu-system](tasks/d3-menu-system.md) — declarative model, web menubar + NSMenu via `menu.publish`, new commands, a11y | a1, a2, c1 | . / main | 9/8 | top | 🔵 in-progress | pipeline implement-task | 2026-08-29 |
